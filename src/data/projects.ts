...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Staff Focus",
    shortDescription: {
      ru: "PWA + Android-приложение для сотрудников: KPI, задачи, мотивация, биометрия, пуш-уведомления",
      en: "PWA + Android app for employees: KPI, tasks, motivation, biometrics, push notifications",
    },
    problem: {
      ru: "Сотрудникам нужен был удобный инструмент для отслеживания задач, KPI и доступа к корпоративной базе знаний прямо с телефона. Плюс нативные возможности: биометрия, push-уведомления.",
      en: "Employees needed a convenient tool for tracking tasks, KPIs, and accessing the knowledge base from their phones — with native capabilities: biometrics and push notifications.",
    },
    solution: {
      ru: "PWA с FSD-архитектурой на React + Vite, конвертированное в нативное Android-приложение через Capacitor. Биометрическая аутентификация, Firebase Cloud Messaging для пушей, NestJS бэкенд с Frappe ERP и Outline Wiki.",
      en: "React + Vite PWA with FSD architecture, converted to native Android app via Capacitor. Biometric authentication, Firebase Cloud Messaging for push notifications, NestJS backend with Frappe ERP and Outline Wiki.",
    },
    contribution: {
      ru: [
        "Архитектура фронтенда по FSD-методологии",
        "Конвертация PWA в Android-приложение через Capacitor",
        "Интеграция биометрической аутентификации (fingerprint/face)",
      ...
      en: [
        ...
        "PWA to Android conversion via Capacitor",
    ...
    stack: ["React", "Vite", "TypeScript", "Tailwind CSS", "Capacitor", "Firebase FCM", "NestJS", "Frappe ERP", "Redis", "Docker"],
    result: {
